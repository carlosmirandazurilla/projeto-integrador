            ...
            <form action="{{ route('customer.address.store', $customer->id) }}" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="alias">Nome do endereço <span class="text-danger">*</span></label>
                        <input type="text" name="alias" id="alias" placeholder="Casa ou Escritório" class="form-control" value="{{ old('alias') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="address_2">Endereçco 2 </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" placeholder="Telefone" class="form-control" value="{{ old('phone') }}">
                    </div>
                </div>
                <!-- /.box-body -->
