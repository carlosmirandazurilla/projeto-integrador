                ...
                <td>
                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="post" class="form-horizontal">
                        ...
                        <div class="btn-group">
                            ...
                            @if($admin->hasPermission('delete-product'))<button onclick="return confirm('Você tem certeza?')" type="submit" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</button>@endif
                        </div>
                    </form>
                </td>
            </tr>
