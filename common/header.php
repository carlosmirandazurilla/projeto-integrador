        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-row">
                    <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+55 11 99999 999</div>
                    <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">mercadoexchange@gmail.com</a></div>
                                    ...
                                    <!-- <div class="custom_dropdown">
                                        <div class="custom_dropdown_list">
                                            ...
                                            <ul class="custom_list clc">
                                                <li><a class="clc" href="#">Categorias</a></li>
                                                <li><a class="clc" href="#">Livros</a></li> 
                                                <li><a class="clc" href="#">Livros</a></li>
                    ...
                    <div class="main_nav_content d-flex flex-row">
                        ...
                        <div class="main_nav_menu ml-auto">
                            <ul class="standard_dropdown main_nav_dropdown">
                                ...
                                <li class="hassubs">
                                    <a href="#">Marcas Parceiras<i class="fas fa-chevron-down"></i></a>
                                    <ul>
                                        <li>
                                            <a href="#">Menu Item<i class="fas fa-chevron-down"></i></a>
                                            <ul>
                ...
                <div class="col">
                    ...
                    <div class="page_menu_content">
                        ...
                        <div class="page_menu_search">
                            <form action="#">
                                <input type="search" required="required" class="page_menu_search_input" placeholder="Encontre seu produto...">
                            </form>
                        </div>
