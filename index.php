				...
				<div class="row"> -->
					...
					<!-- <div class="col-lg-3 col-md-6 char_col">
						...
						<div class="char_item d-flex flex-row align-items-center justify-content-start">
							...
							<div class="char_content">
								<div class="char_title">Frete Grátis</div>
								<div class="char_subtitle">A partir de R$50 ou 1000 pontos</div>
							</div>
						</div>
					</div> -->
					...
					<!-- <div class="col-lg-3 col-md-6 char_col">
						...
						<div class="char_item d-flex flex-row align-items-center justify-content-start">
							...
							<div class="char_content">
								<div class="char_title">Frete Gátis</div>
								<div class="char_subtitle">A partir de R$50 ou 1000 pontos</div>
							</div>
						</div>
					</div> -->
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="popular_categories_content">
							...
							<div class="popular_categories_link"><a href="#">Todos os Produtos</a></div>
						</div>
					</div> -->
							...
							<div class="owl-carousel owl-theme popular_categories_slider"> -->
								...
								<!-- <div class="owl-item">
									<div class="popular_category d-flex flex-column align-items-center justify-content-center">
										...
										<div class="popular_category_text">Tecnologia</div>
									</div>
								</div> -->
								...
								<!-- <div class="owl-item">
									<div class="popular_category d-flex flex-column align-items-center justify-content-center">
										...
										<div class="popular_category_text">Acessórios</div>
									</div>
								</div>
								...
								<div class="row fill_height">
									<div class="col-lg-4 col-md-6 fill_height">
										<div class="banner_2_content">
											...
											<div class="button banner_2_button"><a href="#">Saiba Mais</a></div>
										</div> -->
					...
					<div class="col">
						<div class="tabbed_container">
							<div class="tabs clearfix tabs-right">
								<div class="new_arrivals_title">Produtos em Demanda</div>
								<ul class="clearfix">
												...
												<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
													...
													<div class="product_content">
														...
														<div class="product_extras">
															...
															<button class="product_cart_button active">Adicionar ao Carrinho</button>
														</div>
													</div>
													<div class="product_fav"><i class="fas fa-heart"></i></div>
													<ul class="product_marks">
									...
									<div class="arrivals_single clearfix">
										<div class="d-flex flex-column align-items-center justify-content-center">
											...
											<div class="arrivals_single_content">
												...
												<form action="#"><button class="arrivals_single_button">Adicionar ao Carrinho</button></form>
											</div>
				...
				<div class="row"> -->
					...
					<!-- <div class="col-lg-3">
						<div class="trends_container">
							<h2 class="trends_title">Tendências 2019</h2>
							<div class="trends_text"><p>Sigam as novas tendências do mercado e não percam um segundo em achar seu produto ideal</p></div>
